...
<body>
    <div class="font-sans antialiased min-h-screen flex bg-gray-100 items-center justify-center">
        <div class="w-1/2">
            <div class="p-10 border rounded-xl bg-white text-center">
                <h1 class="font-semibold text-2xl m-2">Join With Us</h1>
                <div class="text-xl text-gray-600 mb-5">New Social Network....</div>
